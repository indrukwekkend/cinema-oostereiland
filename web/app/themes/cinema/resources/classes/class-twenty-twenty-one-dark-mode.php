...
class Twenty_Twenty_One_Dark_Mode {
	...
	public function customizer_controls( $wp_customize ) {
		...
		include_once get_template_directory() . '/classes/class-twenty-twenty-one-customize-notice-control.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
