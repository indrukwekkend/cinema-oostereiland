...
add_action('after_setup_theme', function () {
	...
	register_block_pattern(
		...
		array(
			...
			'content'       => '<!-- wp:columns {"verticalAlignment":"center","align":"wide","className":"is-style-indrukwekkend-columns-zonder"} --><div class="wp-block-columns alignwide are-vertically-aligned-center is-style-indrukwekkend-columns-zonder"><!-- wp:column {"verticalAlignment":"center"} --><div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"align":"full","sizeSlug":"extraContent"} --><figure class="wp-block-image alignfull size-extraContent"><img src="' . asset_path('images/the_shining.jpg') . '" alt="' . esc_attr__( 'The Shining', 'indrukwekkend' ) . '"/></figure><!-- /wp:image --></div><!-- /wp:column --><!-- wp:column {"verticalAlignment":"center"} --><div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"align":"full",sizeSlug":"extraContent"} --><figure class="wp-block-image alignfull size-extraContent"><img src="' . asset_path('images/walken.jpg') . '" alt="' . esc_attr__( 'Christopher Walken -- Pulp Fiction', 'indrukwekkend' ) . '"/></figure><!-- /wp:image --></div><!-- /wp:column --></div><!-- /wp:columns -->',
		)
	);
